function XY = getTriangleFlyOrient(f,thisFly,thisFrame)
%getTriangleFlyOrient
% XY = getTriangleFlyOrient(f,thisFly,thisFrame)
...
THETA = (f.tracking_info.orientation(thisFly,thisFrame)*pi/180);            % get fly orientation in radians
