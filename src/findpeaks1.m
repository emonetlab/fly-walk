function [Ypk,Xpk,Wpk,Ppk,bxPk] = findpeaks1(Yin,varargin)
...
if nargout > 0
  ...
  if needWidth
    [Ypk,Xpk,Wpk,Ppk,bxPk] = assignFullOutputs(y,x,iPk,wxPk,bPk,yIsRow,xIsRow,bxPk);
  else
...
%--------------------------------------------------------------------------
function [YpkOut,XpkOut,WpkOut,PpkOut,bxPkOut] = assignFullOutputs(y,x,iPk,wxPk,bPk,yIsRow,xIsRow,bxPk)
