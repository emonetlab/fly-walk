...
filelist5 = dir('*.txt');
filelist6 = dir('*.xls');
filelist7 = dir('*.kontroller');
% filelist = [filelist1;filelist2;filelist3;filelist4];
filelist = [filelist1;filelist2;filelist5;filelist6;filelist7;filelist3];
...
dest_fldr = ['Y:\home\mahmut_demir\Walking Assay',filesep,cur_fldr];
